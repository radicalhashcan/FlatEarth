...
Earn "The First Rule of Brawler's Guild" Achievement |achieve 11558 |goto Deeprun Tram/2 72.64,18.96
...
Travel to the Past |havebuff 609811 |goto Dustwallow Marsh/0 55.91,49.54 |achieve 1686 |future
step
use the Mistletoe##21519
...
Fight #5# Fires |q 11360/1 |goto 42.60,60.22
...
step
talk Costumed Orphan Matron##24519
turnin Smash the Pumpkin##12133 |goto 42.62,64.38
step
...
Run down the stairs |goto 53.25,42.57 < 5 |walk
...
|tip It appears as a button on the screen.
|tip Use it on the burning scarecrows around this area.
Put Out the Fires |q 11131/1 |goto 42.60,60.22
...
|tip It appears as a button on the screen.
|tip Use it on the burning scarecrows around this area.
Put Out the Fires |q 12135/1 |goto 42.60,60.22
...
step
talk Costumed Orphan Matron##24519
turnin Stop the Fires!##11131 |goto 42.62,64.39 |only if havequest(11131)
turnin "Let the Fires Come!"##12135 |goto 42.62,64.39 |only if havequest(12135)
turnin Smash the Pumpkin##12133 |goto 42.62,64.39 |only if havequest(12133)
step
talk Zidormi##141488
...
Douse the Horde's Wickerman |q 29371/1 |goto 62.38,68.19
...
step
kill Captain Bonerender##96535 |q Mutiny on the Boneship##39719/1 |goto Shadowmoon Valley D/0 38.76,86.29
step
label "Slay_Boneship_Crewmen"
Kill enemies around this area
Kill #12# Boneship Crewmen |q Culling the Crew##39721/1 |goto 39.8,80.4
step
label "Slay_Growing_Squashlings"
kill 6 Growing Squashling##96545+ |q Smashing Squashlings##39716/1 |goto 40.2,81.8
step
...
Destroy #8# Fertilizers |q Foul Fertilizer##39720/1 |goto 40.1,84.3
step
talk Izzy Hollyfizzle##96362
...
Gain the Curse of the Crooked Tree Buff |havebuff 1379178 |goto 35.03,56.05 |q 43162
step
...
click Candy Bucket##208144
|tip Inside the building.
Complete the Candy Bucket quest use the Handful of Treats##37586
|tip If you cannot complete this quest because of a "Duplicate item found" message, open the Handful of Treats item in your bags and take out the contents.
...
|tip They look like Stormwind Guards with a glowing pink aura around them all over Stormwind.
...
step
Follow the path |goto 63.76,72.76 < 15 |only if walking
Leave Stormwind |goto 69.17,79.30 < 10 |only if walking
Cross the bridge |goto 69.74,83.77 < 15 |only if walking
Continue following the path |goto Elwynn Forest/0 31.88,48.88 < 15 |only if walking
Get the Crown Chemical Co. Package |havebuff 132763 |q 24656 |goto Stormwind City/0 78.75,89.34
step
Cross the bridge |goto 74.25,92.39 < 15 |only if walking
Enter Stormwind |goto 69.03,79.44 < 10 |only if walking
Follow the path |goto 63.64,75.23 < 10 |only if walking
Deliver the Package in Time |q 24656/1 |goto 61.51,75.27
|tip If you lose your disguise, ask Inspector Snip Snagglebolt for another one.
step
talk Inspector Snip Snagglebolt##38066
turnin Pilfering Perfume##24656 |goto 61.51,75.27
accept Fireworks At The Gilded Rose##24848 |goto 61.51,75.27
step
Enter the building |goto 61.01,74.68 < 5 |walk
Run up the stairs |goto 59.83,75.71 < 5 |only if walking
...
step
Enter the building |goto 62.44,77.11 < 5 |walk
Watch the dialogue
|tip Inside the building.
Search the Stormwind Counting House |q 24849/1 |goto 63.03,78.74
step
Enter the building |goto 61.67,72.51 < 5 |walk
Watch the dialogue
|tip Inside the building.
Search the Stormwind Auction House |q 24849/2 |goto 61.42,71.61
step
Enter the building |goto 61.37,65.80 < 5 |walk
Watch the dialogue
|tip Inside the building.
...
collect Snivel's Ledger##49915 |q 24657/1 |goto 27.43,34.83
step
talk Inspector Snip Snagglebolt##38066
...
step
Complete the "Love is in the Air Main Questline" guide before using this guide |q 24657
Click here to load the "Love is in the Air Main Questline" guide |confirm |next "Events Guides\\Love is in the Air\\Love is in the Air Main Questline"
step
talk Inspector Snip Snagglebolt##38066
...
accept A Perfect Puff of Perfume##24629 |or |goto 62.41,75.38
accept A Cloudlet of Classy Cologne##24635 |or |goto 62.41,75.38
accept Bonbon Blitz##24636 |or |goto 62.41,75.38
step
...
step
Enter the building |goto 46.27,73.45 < 5 |walk
Run up the stairs |goto 46.65,73.38 < 5 |only if walking
click Recipe Fragment##6478
|tip Upstairs inside the building.
Collect the 1st Fragment |q 44560/1 |goto 46.28,73.51
only if havequest(44560)
step
Enter the building |goto 44.98,71.64 < 5 |walk
click Recipe Fragment##6478
|tip Inside the building.
...
step
talk Inspector Snip Snagglebolt##38066
turnin Crushing the Crown##44558 |goto Stormwind City/0 61.51,75.27
turnin Follow the Recipe##44560 |goto Stormwind City/0 61.51,75.27
step
talk Public Relations Agent##37675
turnin A Perfect Puff of Perfume##24629 |only if havequest(24629) |goto 62.41,75.38
turnin A Cloudlet of Classy Cologne##24635 |only if havequest(24635) |goto 62.41,75.38
turnin Bonbon Blitz##24636 |only if havequest(24636) |goto 62.41,75.38
step
Killing any enemy that rewards experience will drop _Charms_
|tip Enemies with levels showing Green, Yellow, Orange or Red.
collect 40 Lovely Charm##49655 |n
use the Lovely Charm##49655
collect 4 Lovely Charm Bracelet##49916
step
Enter the building |goto 80.68,37.82 < 5 |walk
talk Anduin Wrynn##107574
|tip Inside the building.
...
talk Zidormi##141489
Ask her _"Can you show me what Darkshore was like before the battle?"_
Return to Darkshore's Past |havebuff 609811 |goto Darkshore/0 48.86,24.46 |q 24610 |future
step
talk Kwee Q. Peddlefeet##16075
accept A Gift for the High Priestess of Elune##24610 |goto Darnassus/0 45.42,57.75
step
Enter the building |goto 43.01,74.83 < 5 |walk
Run up the ramp |goto 43.97,85.05 < 10 |walk
Continue following the path |goto 46.26,82.37 < 10 |walk
...
Continue up the ramp |goto 63.94,36.08 < 10 |walk
talk Kwee Q. Peddlefeet##16075
accept A Gift for the Prophet##24611 |goto 73.65,57.01
step
Run down the ramp |goto 73.95,53.63 < 10 |walk
Continue down the ramp |goto 58.85,31.07 < 10 |walk
Follow the path |goto 51.51,47.22 < 15 |walk
...
step
Follow the path |goto 38.41,71.29 < 5 |walk
Enter the building |goto 44.39,49.69 < 10 |walk
talk Muradin Bronzebeard##42928
turnin A Gift for the Lord of Ironforge##24609 |goto 39.19,56.09
]])
ZygorGuidesViewer:RegisterGuide("Events Guides\\Love is in the Air\\Love is in the Air Achievements",{
author="support@zygorguides.com",
condition_suggested=function() return isevent('Love is in the Air') end,
...
You can get Love Tokens by completing the dailies using the "Love is in the Air Dailies" guide
|tip You will need roughly 101 Love Tokens to buy everything needed for the achievements.
Click here to load the "Love is in the Air Dailies" guide |confirm |next "Events Guides\\Love is in the Air\\Love is in the Air Dailies"
Click here to continue to the vendors |confirm
step
talk Lovely Merchant##37674
buy 1 Bag of Heart Candies##21813 |goto Stormwind City/0 62.49,75.24 |condition achieved(1701)
|tip You may have to buy more than 1 to get all of the candies.
step
use Bag of Heart Candies##21813
Collect "Be Mine" |collect 1 Heart Candy##21816 |condition achieved(1701,1)
Collect "I'll Follow You All Around Azeroth" |collect 1 Heart Candy##21818 |condition achieved(1701,2)
Collect "All Yours" |collect 1 Heart Candy##21819 |condition achieved(1701,3)
Collect "I'm All Yours" |collect 1 Heart Candy##21821 |condition achieved(1701,4)
Collect "Hot Lips" |collect 1 Heart Candy##21823 |condition achieved(1701,5)
Collect "You're Mine"|collect 1 Heart Candy##21822 |condition achieved(1701,6)
Collect "You're the Best" |collect 1 Heart Candy##21820 |condition achieved(1701,7)
Collect "I LOVE YOU" |collect 1 Heart Candy##21817 |condition achieved(1701,8)
step
use Heart Candy##21816
Eat the "Be Mine!" Candy |achieve 1701/1
step
use Heart Candy##21818
Eat the "I'll Follow You All Around Azeroth." Candy |achieve 1701/2
step
use Heart Candy##21819
Eat the "All Yours." Candy |achieve 1701/3
step
use Heart Candy##21821
Eat the "I'm All Yours!" Candy |achieve 1701/4
step
use Heart Candy##21823
Eat the "Hot Lips." Candy |achieve 1701/5
step
use Heart Candy##21822
Eat the "You're Mine!" Candy |achieve 1701/6
step
use Heart Candy##21820
Eat the "You're the Best!" Candy |achieve 1701/7
step
use Heart Candy##21817
Eat the "I LOVE YOU" Candy |achieve 1701/8
step
talk Lovely Merchant##37674
buy 10 Silver Shafted Arrow##22200 |goto Stormwind City/0 62.49,75.24 |condition achieved(1188)
step
use Silver Shafted Arrow##22200
|tip Use it on 10 players inside Ironforge.
Shoot 10 Players with the Silver Shafted Arrow |achieve 1188 |goto Ironforge/0 31.51,65.13
step
talk Lovely Merchant##37674
buy 1 Box of Chocolates##49909 |goto 62.49,75.24 |condition achieved(1702)
step
use Box of Chocolates##49909
collect Buttermilk Delight##22236 |condition achieved(1702,1)
collect Dark Desire##22237 |condition achieved(1702,2)
collect Sweet Surprise##22239 |condition achieved(1702,3)
collect Very Berry Cream##22238 |condition achieved(1702,4)
step
use Buttermilk Delight##22236
Sample the Buttermilk Delight |achieve 1702/1
|tip Save the remaining Buttermilk Delights for a later achievement.
step
use Dark Desire##22237
Sample the Dark Desire |achieve 1702/2
step
use Sweet Surprise##22239
Sample the Sweet Surprise |achieve 1702/3
step
use Very Berry Cream##22238
Sample the Very Berry Cream |achieve 1702/4
step
talk Lovely Merchant##37674
buy 10 Love Rocket##34258 |goto Stormwind City/0 62.49,75.24 |condition achieved(1696)
step
use Love Rocket##34258
|tip Use them quickly to set off all 10 in 20 seconds or less.
Shoot off 10 Love Rockets in 20 Seconds or Less |achieve 1696
step
talk Lovely Merchant##37674
buy 15 Handful of Rose Petals##22218 |goto 62.49,75.24 |condition achieved(1699)
buy 1 Romantic Picnic Basket##34480 |goto 62.49,75.24 |condition achieved(1291)
buy 1 "VICTORY" Perfume##49856 |goto 62.49,75.24 |condition achieved(1279)
buy 5 Love Fool##22261 |goto 62.49,75.24 |condition achieved(1704)
step
Enter the building |goto 75.13,55.30 < 5 |walk
talk Elly Langston##1328
|tip She walks around inside the building.
buy 6 Flagon of Mead##2594 |goto 75.32,53.71 |condition achieved(1279)
step
Throw a Handful of Rose Petals on Each Race/Class Combination Below:
use Handful of Rose Petals##22218
|tip This can be done anywhere.
|tip Dalaran or Battlegrounds are usually a good place to find lots of players of both factions.
...
use Romantic Picnic Basket##34480
use Buttermilk Delight##22236
Enjoy a Buttermilk Delight with Someone in Dalaran at a Romantic Picnic |achieve 1291 |goto Dalaran L/10 57.61,44.26
step
use Love Fool##22261
...
use Flagon of Mead##2594
|tip Use all 6 of your Flagons of Mead to get Completely Smashed.
use "VICTORY" Perfume##49856
clicknpc Sraaz##9099
use Handful of Rose Petals##22218
...
step
The following bosses can drop the item needed for the last achievement:
|tip Click the boss' name to be directed to that dungeon.
|tip These dungeons can be done on Normal or Heroic mode.
Drahga Shadowburner in Grim Batol |goto Grim Batol/1 12.77,55.31
Corla, Herald of Twilight in Blackrock Caverns |goto Blackrock Caverns/1 34.29,69.66
High Priestess Azil in The Stonecore |goto The Stonecore/1 54.09,90.60
Admiral Ripsnarl in Deadmines |goto The Deadmines/1 24.96,13.92
Lord Godfrey in Shadowfang Keep |goto Shadowfang Keep/1 67.58,59.40
|tip Get either of these 2 items as a drop from any of these bosses.
...
step
Become a Fool For Love |achieve 1693
step
_Congratulations!_
You Earned the "Fool For Love" Achievement.
]])
...
accept Dreamseer the Elder##8671 |goto Tanaris/0 51.40,28.81
step
...
|tip There is at least one available at all times.
use the Brightly Colored Egg##45072+
collect 50 Noblegarden Chocolate##44791 |goto Dun Morogh/0 53.51,50.84
step
talk Noblegarden Vendor##32836
buy 1 Black Tuxedo Pants##151804 |goto 54.11,50.82
step
talk Noblegarden Vendor##32836
buy 1 White Tuxedo Shirt##6833 |goto 54.11,50.82
step
...
|tip There is at least one available at all times.
use the Brightly Colored Egg##45072+
collect 100 Noblegarden Chocolate##44791 |goto Dun Morogh/0 53.51,50.84
step
...
|tip There is at least one available at all times.
use the Brightly Colored Egg##45072+
collect 25 Noblegarden Chocolate##44791 |goto Dun Morogh/0 53.51,50.84
step
use the Noblegarden Chocolate##44791+
...
step
talk Noblegarden Vendor##32836
buy 1 Spring Robes##44800 |goto 54.11,50.82
step
...
use the Brightly Colored Egg##45072+
collect 1 Elegant Dress##151806 |achieve 249 |goto Dun Morogh/0 53.51,50.84
step
|achieve 249
step
_Congratulations!_
...
|tip There is at least one available at all times.
use the Brightly Colored Egg##45072+
Gain the "Noblegarden Bunny" Buff |havebuff 237000 |goto Dun Morogh/0 53.51,50.84
step
...
click Brightly Colored Egg##113768+
|tip There is at least one available at all times.
collect 1 Brightly Colored Egg##113768 |achieve 2676 |goto Dun Morogh/0 53.51,50.84
step
|achieve 2676
step
_Congratulations!_
...
|tip There is at least one available at all times.
use the Brightly Colored Egg##45072+
collect 5 Noblegarden Chocolate##44791 |goto Elwynn Forest/0 42.38,65.61
step
talk Noblegarden Vendor##32836
buy 1 Noblegarden Egg##44818 |goto 43.04,65.32
step
use Noblegarden Egg##44818
|achieve 2421 |goto Stormwind City/0 72.99,89.93
step
_Congratulations!_
...
step
talk Noblegarden Vendor##32836
buy 1 Spring Flowers##45073 |goto Dun Morogh/0 54.11,50.82
step
...
step
talk Noblegarden Vendor##32836
buy 1 Spring Rabbit's Foot##44794 |goto 54.11,50.82
step
use the Spring Rabbit's Foot##44794
|learnpet 61725
step
|achieve 2419/4 |goto 53.49,50.85
...
step
|achieve 2419/3 |goto Elwynn Forest/0 43.1,67.6
|tip Summon your Spring Rabbit and find another player who has one summoned.
|tip Spring Rabbits are white with brown spots.
|tip Walk near the other player's rabbit to get credit.
step
|achieve 2419/2 |goto Teldrassil/0 55.45,50.42
|tip Summon your Spring Rabbit and find another player who has one summoned.
|tip Spring Rabbits are white with brown spots.
|tip Walk near the other player's rabbit to get credit.
step
|achieve 2419/1 |goto Azuremyst Isle/0 49.12,51.49
|tip Summon your Spring Rabbit and find another player who has one summoned.
|tip Spring Rabbits are white with brown spots.
|tip Walk near the other player's rabbit to get credit.
step
...
|tip You may need to loot hundreds, if not thousands of these eggs.
use the Brightly Colored Egg##45072+
collect 1 White Tuxedo Shirt##6833 |achieve 248/1 |goto Dun Morogh/0 53.51,50.84
step
click Brightly Colored Egg##113768+
|tip There is at least one available at all times.
|tip You may need to loot hundreds, if not thousands of these eggs.
use the Brightly Colored Egg##45072+
collect 1 Black Tuxedo Pants##151804 |achieve 248/2 |goto 53.51,50.84
step
|achieve 248
step
_Congratulations!_
