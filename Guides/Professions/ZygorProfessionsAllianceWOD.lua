...
ZygorGuidesViewer:RegisterGuide("Profession Guides\\Archaeology\\Leveling Guides\\Warlords of Draenor\\Archaeology 600-700 Leveling Guide",{
author="support@zygorguides.com",
...
|only if skill("Draenor Cooking") < 100
step
collect 100 Raw Clefthoof Meat
|tip Farm them or purchase them from the Auction House.
|only if skill("Draenor Cooking") < 100
step
_<Create a Cooking Fire>_
...
author="support@zygorguides.com",
description="Blackrock can be gathered from Shadowmoon Valley, Draenor.",
...
author="support@zygorguides.com",
description="True Iron can be gathered from Shadowmoon Valley, Draenor.",
condition_end=function() return skill('Draenor Mining') >= 50 end,
},[[
step
map Shadowmoon Valley D/0
