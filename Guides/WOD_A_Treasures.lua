...
'| click Abu'Gar's Favorite Lure##233642 |condition itemcount(114245)>0 |or
...
'| click Abu'gar's Missing Reel##233506 |condition itemcount(114243)>0 |or
...
'| click Abu'gar's Vitality##233157 |condition itemcount(114242)>0 |or
...
step
|poi_treasure Pippers' Buried Supplies 1
|poilvl 90
|poispot Lunarfall/0 42.40,54.36
|poiquest 35381
|poicurrency GR
click Pippers' Buried Supplies 1##232252 |q 35381 |future |goto Lunarfall/0 42.4,54.4
only if garrisonlvl(1)
step
|poi_treasure Pippers' Buried Supplies 1
|poilvl 90
...
|poiquest 35381
|poicurrency GR
click Pippers' Buried Supplies 1##232252 |q 35381 |future |goto Lunarfall/0 41.5,58.1
only if garrisonlvl(2)
step
|poi_treasure Pippers' Buried Supplies 1
|poilvl 90
...
only if garrisonlvl(3)
step
|poi_treasure Pippers' Buried Supplies 2
|poilvl 90
|poispot Lunarfall/0 50.70,48.50
|poiquest 35382
|poicurrency GR
click Pippers' Buried Supplies 2##232252 |q 35382 |future |goto Lunarfall/0 50.6,48.4
only if garrisonlvl(1)
step
|poi_treasure Pippers' Buried Supplies 2
|poilvl 90
...
|poiquest 35382
|poicurrency GR
click Pippers' Buried Supplies 2##232252 |q 35382 |future |goto Lunarfall/0 51.9,45.1
only if garrisonlvl(2)
step
|poi_treasure Pippers' Buried Supplies 2
|poilvl 90
...
only if garrisonlvl(3)
step
|poi_treasure Pippers' Buried Supplies 3
|poilvl 90
|poispot Lunarfall/0 30.80,28.30
|poiquest 35383
|poicurrency GR
click Pippers' Buried Supplies 3##232252 |q 35383 |future |goto Lunarfall/0 31.1,27.6
only if garrisonlvl(1)
step
|poi_treasure Pippers' Buried Supplies 3
|poilvl 90
...
|poiquest 35383
|poicurrency GR
click Pippers' Buried Supplies 3##232252 |q 35383 |future |goto Lunarfall/0 35.0,23.8
only if garrisonlvl(2)
step
|poi_treasure Pippers' Buried Supplies 3
|poilvl 90
...
only if garrisonlvl(3)
step
|poi_treasure Pippers' Buried Supplies 4
|poilvl 90
|poispot Lunarfall/0 49.19,76.83
|poiquest 35384
|poicurrency GR
click Pippers' Buried Supplies 4##232252 |q 35384 |future |goto Lunarfall/0 49.1,76.9
only if garrisonlvl(1)
step
|poi_treasure Pippers' Buried Supplies 4
|poilvl 90
...
|poiquest 35384
|poicurrency GR
click Pippers' Buried Supplies 4##232252 |q 35384 |future |goto Lunarfall/0 46.5,76.1
only if garrisonlvl(2)
step
|poi_treasure Pippers' Buried Supplies 4
|poilvl 90
...
only if garrisonlvl(3)
step
|poi_treasure Spark's Stolen Supplies
|poilvl 90
